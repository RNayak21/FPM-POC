...
service demoFpm {
    ...
    entity JiraIdVH as projection on JiraEntity {
        key defectID
    }

    view FunctionalAreaVH as select from JiraEntity distinct {
        key functionalArea
    }
    ...
    view DefectStatusVH as select from JiraEntity distinct {
            key defectStatus
    }
    view TypeVH as select from JiraEntity distinct {
            key Type
    }
